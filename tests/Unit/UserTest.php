...
/**
 * @method static assertEquals(string $value, string $getUsername)
 * @method static assertInstanceOf(string $class, User $response)
 * @method static assertContains(string $string, array $getRoles)
 * @method static assertCount(int $int, Article[]|\Doctrine\Common\Collections\Collection $getArticles)
 * @method static assertTrue(bool $contains)
 * @method static assertFalse(bool $contains)
 */
